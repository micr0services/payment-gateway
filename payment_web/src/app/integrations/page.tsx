      ...
      <div className="relative z-10 w-full max-w-[600px] px-4 sm:px-0">
        ...
        <form onSubmit={handleSubmit} className="bg-surface border border-border rounded-sm shadow-[0_0_0_1px_rgba(201,168,76,0.08),0_40px_80px_rgba(0,0,0,0.6),0_0_120px_rgba(201,168,76,0.04)] p-6 sm:p-8">
          <div className="space-y-6">
            {/* Name */}
            <div>
              <label className="block text-xs uppercase tracking-[0.2em] text-text mb-1.5">Full Name</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            {/* Email */}
            <div>
              <label className="block text-xs uppercase tracking-[0.2em] text-text mb-1.5">Email Address</label>
              <input
                type="email"
                name="email"
            ...
            {/* Company */}
            <div>
              <label className="block text-xs uppercase tracking-[0.2em] text-text mb-1.5">Company</label>
              <input
                type="text"
                name="company"
            ...
            {/* Service Type */}
            <div>
              <label className="block text-xs uppercase tracking-[0.2em] text-text mb-1.5">Service Type</label>
              <select
                name="service"
                value={formData.service}
                onChange={handleChange}
                required
                className="w-full bg-surface-2 border border-border rounded-sm p-3.5 text-text font-mono text-sm focus:outline-none focus:border-[rgba(201,168,76,0.4)] focus:shadow-[0_0_0_3px_rgba(201,168,76,0.15)] appearance-none cursor-pointer"
                style={{
            ...
            {/* Message */}
            <div>
              <label className="block text-xs uppercase tracking-[0.2em] text-text mb-1.5">Project Details</label>
              <textarea
                name="message"
                ...
                required
                rows={5}
                className="w-full bg-surface-2 border border-border rounded-sm p-3.5 text-text font-mono text-sm placeholder:text-text-muted focus:outline-none focus:border-[rgba(201,168,76,0.4)] focus:shadow-[0_0_0_3px_rgba(201,168,76,0.15)] resize-none"
            ...
            <button
              ...
              className="w-full bg-gold hover:bg-gold-light text-obsidian font-mono text-xs uppercase tracking-[0.15em] py-4 px-6 rounded-sm transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
